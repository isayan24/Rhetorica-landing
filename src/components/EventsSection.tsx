...
//     <section
//       id="events"
//       className="bg-[#EFE0BE] py-24 overflow-hidden relative w-full"
//     >
...
//               <SwiperSlide
//                 key={idx}
//                 style={{ width: "420px" }} // Sizing lock for Coverflow scaling calculations
//                 className="shrink-0 flex flex-col items-center gap-14 bg-transparent border-0 p-0 shadow-none select-none"
//               >
//                 <div className="relative h-[480px] w-full overflow-hidden rounded-xl bg-transparent">
