...
export const FooterSection: React.FC<FooterSectionProps> = ({ onScrollTo }) => {
  return (
    <footer className="w-full bg-white flex flex-col relative overflow-hidden">
      
      {/* Upper Content Section with Watercolor Painting Background */}
      {/* Matches the exact height (min-h-[135vh] md:min-h-0 md:h-[600px]) and padding from the live source */}
      <motion.div 
        initial={{ opacity: 0 }}
      ...
      >
        ...
        >
          ...
          {/* Exact separating line matching gradient and weight */}
        ...
        >
          ...
          <span 
            onClick={() => onScrollTo("edition")}
            className="cursor-pointer text-[12px] md:text-lg hover:underline transition"
          >
            ‘26 Edition
          </span>
          <span 
            onClick={() => onScrollTo("countdown")}
            className="cursor-pointer text-[12px] md:text-lg hover:underline transition"
          >
            Countdown
          </span>
          ...
          <span 
            onClick={() => onScrollTo("collaborations")}
            className="cursor-pointer text-[12px] md:text-lg hover:underline transition"
          >
            Collaborations
          </span>
        ...
        >
          ...
          <span className="flex gap-2 mb-2 mt-1">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor" className="h-5 w-5 md:h-6 md:w-6">
                ...
                <path d="M17.5078 6.5L17.4988 6.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
              </svg>
            </a>
            <a 
              target="_blank" 
          ...
          <div className="mt-2 md:mt-4 space-y-1">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor" className="h-4 w-4">
                <path d="M2 5L8.91302 8.92462C11.4387 10.3585 12.5613 10.3585 15.087 8.92462L22 5" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5"></path>
      ...
      >
        ...
        <p className="md:hidden mt-3 leading-relaxed">
          ...
          <br />
          & Rhetorica Organising Committee
        </p>
